        ...
        <div className="relative z-10 flex flex-col h-full">
          ...
          <div className="space-y-4 mb-6 flex-1 overflow-y-auto">
            ...
            <div className="bg-white/95 backdrop-blur-sm rounded-2xl p-6 shadow-xl border border-white/30">
              <div className="flex items-center mb-4">
                ...
                <div>
                  <h3 className="font-bold text-gray-800 text-xl">{assignedQueue?.department || 'แผนกอายุรกรรม'}</h3>
              ...
              <div className="grid grid-cols-2 gap-4 text-sm">
                <div className="bg-gray-50 rounded-xl p-3">
                  ...
                  <p className="text-gray-800 font-semibold">{assignedQueue?.building || 'อาคาร A'}</p>
                  <p className="text-gray-800 font-semibold">{assignedQueue?.floor || 'ชั้น 2'}</p>
                  <p className="text-gray-800 font-semibold">{assignedQueue?.room || 'ห้อง 201'}</p>
                </div>
                <div className="bg-gray-50 rounded-xl p-3">
                  <p className="text-gray-600 mb-1 font-medium">สถานะคิว</p>
                  <p className="text-gray-800 font-semibold">คิวปัจจุบัน: {assignedQueue?.currentQueue || 'A001'}</p>
                  <p className="text-gray-800 font-semibold">ผู้รอ: {assignedQueue?.totalWaiting || 5} คน</p>
                </div>
              </div>
            </div>
          ...
          <div className="space-y-4">
            ...
            <div className="grid grid-cols-2 gap-4">
              <button
                onClick={() => navigate('/screening/queue-status', {
                  state: {
                    queue: assignedQueue,
                    patient: patientData,
                    symptoms: symptoms
                ...
                className="bg-gradient-to-r from-blue-500 to-purple-600 text-white font-bold py-4 px-6 rounded-2xl shadow-xl hover:shadow-2xl active:scale-95 transition-all flex items-center justify-center space-x-2 border border-white/30"
              >
            ...
            <div className="grid grid-cols-2 gap-4">
              <button
                ...
                className="bg-orange-500/90 backdrop-blur-sm text-white font-bold py-3 px-4 rounded-xl active:scale-95 transition-all border border-white/30"
              >
              ...
              <button
                ...
                className="bg-purple-500/90 backdrop-blur-sm text-white font-bold py-3 px-4 rounded-xl active:scale-95 transition-all border border-white/30"
              >
                <div className="flex items-center justify-center space-x-2">
                  <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
